# Generated by Powerlevel10k configuration wizard on 2025-02-12 at 20:54 CET.
...
() {
  ...
  # Commented out so the current kube context/cluster is ALWAYS shown in the prompt.
